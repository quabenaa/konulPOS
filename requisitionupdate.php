			...
			<div id="main-content" class="clearfix">
					...
					<div id="page-content" class="clearfix">
						...
						<div class="page-header position-relative">
							<h1>Requisition <small><i class="icon-double-angle-right"></i> Record</small></h1>
						</div><!--/page-header-->
                        <?php if(!isset($code)){ ?>
                        <div class="row-fluid">
						  <div class="span12">
                                <form action="requisitionupdate.php" method="get">
							...
							<div class="row-fluid">
                                ...
                                <tbody>
										...
										<span class="input-icon"><i class="icon-barcode"></i>
                                          <input type="text" name="code" id="code" class="input-large" value="<?php echo @$row2['Stock Code']; ?>"></span>                                          <input type="hidden" name="id"  size="20" value="<?php echo @$row2['ID']; ?>"></td>
						          </tr>
								        <tr>
									...
									<input type="text" class="input-large" name="stockname" value="<?php echo @$row2['Stock Name']; ?>" /></span>
                                        ...
                                        <tr>
								          <td class="controls controls-row"><label class="small-labels">Requisition Date</label>
                                       <span class="input-icon"> <i class="icon-calendar"></i>
						 <?php
							 if (!isset($id)){
						   ?>
							  <input type="text" size="31" class="input-large date-picker" name="reqdate" value="<?php echo date('m-d-Y'); ?>">
						   <?php
							 }else{
						   ?>
							  <input type="text" size="31" class="input-large date-picker" name="reqdate" value="<?php echo date('m-d-Y',strtotime($row['Stock Date'])); ?>">
						   <?php
							 }
						   ?></span></td>
							            </tr>
                                      ...
                                      ?> 
                                        ...
                                        <tr>
                                          ...
                                          <select name="destination" class="select" size="1" value="<?php echo @$row['Destination']; ?>">
											  <?php
                                      ...
                                      <div class="span3">
                                          ...
                                          <input type="text" name="units" class="input-large" value="<?php echo @$row2['Units in Stock']; ?>" onKeyUp="return autocalc(this,qntyadded)">
											    ...
											    <tr>
											      <td class="controls controls-row"><label class="small-labels">Quantity Requested</label>
											        <span class="input-icon"><i class="icon-plus-sign"></i>
                                          <input type="text" class="input-large" name="qntyreq" width="31" value="<?php echo @$row['Qnty Req']; ?>">
                                          </span>
                                                    </td>
										        </tr>
											    <tr>
											      <td class="controls controls-row"><label class="small-labels">Quantity Given</label>
                                                  <span class="input-icon"> <i class="icon-stethoscope"></i>
											        <input type="text" class="input-large red" name="qntygiven" size="31" value="<?php echo @$row['Qnty Given']; ?>">
											        </span>
											        </td>
										        </tr>
											    <tr>
											      <td class="controls controls-row"><label class="small-labels">Requested By</label>
                                                  <span class="input-icon"> <i class="icon-beaker"></i>
											       <input class="input-large" type="text" name="requestby" size="31" value="<?php echo @$row['Request By']; ?>">
											        </span>
											       </td>
										        </tr>
											    <tr>
											      <td class="controls controls-row"><label class="small-labels">Given By</label>
                                                  <span class="input-icon"> <i class="icon-beaker"></i>
											       <input class="input-large" type="text" name="givenby" size="31" value="<?php echo @$row['Given By']; ?>">
											        </span>
											       </td>
										        </tr>
                                                <tr>
                                                  ...
                                                  <span class="input-icon"> <i class="icon-beaker"></i>
											       <input class="input-large" type="text" name="approvedby" width="31" value="<?php echo @$row['Approved By']; ?>">
											        </span>
											       </td>
										        </tr>
										      </tbody>
