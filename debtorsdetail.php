...
$ID=$_REQUEST['ID'];
$sql="SELECT * FROM `debtor` WHERE `ID`='$ID' order by `Date` desc";
...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Debtors - KONUL [ POS Management System ]</title>
			...
			if ($_SESSION['access_lvl'] == 2 || $_SESSION['access_lvl'] == 5){?>
					<li class="open active">
					  ...
					  <ul class="submenu">
						...
						<li class="active"><a href="debtors.php"><i class="icon-double-angle-right"></i> Debtors Schedule</a></li>
			...
			<div id="main-content" class="clearfix">
					...
					<div id="breadcrumbs">
						<ul class="breadcrumb">
                            ...
                            <li><a href="#">Accounts</a> <span class="divider"><i class="icon-angle-right"></i></span></li>
							<li class="active">Debtors' Schedule</li>
						</ul><!--.breadcrumb-->
					</div><!--#breadcrumbs-->
					...
					<div id="page-content" class="clearfix">
						...
						<div class="page-header position-relative">
							<h1>Debtors Schedule <small><i class="icon-double-angle-right"></i> Details</small></h1>
						</div><!--/page-header-->
						<form action="submitdebtor.php" method="post">
							<div class="row-fluid">
                                ...
                                <tbody>
								        <tr>
                                          ...
                                          <label class="small-labels">Company : </label>
                                          <span class="input-icon"> <i class="icon-user"></i>
                                          <input id="inputField" class="input-large date-picker" type="text" name="company" value="<?php echo @$row['Company']; ?>">  </span>                                     
                                          </td>
						          </tr>
								        <tr>
								          <td class="controls controls-row">
									   ...
									   ?>
								        ...
								        <tr>
								          <td class="controls controls-row">
                                          <label class="small-labels">Contact Person : </label>
                                          <span class="input-icon"> <i class="icon-user"></i>
                                          <input id="inputField" class="input-large date-picker" type="text" name="contact" value="<?php echo @$row['Contact Person']; ?>">
                                          </span>                    
                                          <br>
                                          </td>
						          		</tr>
                                        <tr>
										<td class="controls controls-row"> <label class="small-labels">Debt Amount : </label>
                                        <span class="input-icon"> <i class="icon-money"></i>
										<input type="text" class="input-large" name="amount" value="<?php echo @$row['Amount']; ?>"></span>
										</td>
									  </tr>
                                      <tr>
										<td class="controls controls-row"> <label class="small-labels">Amount Paid : </label>
                                        <span class="input-icon"> <i class="icon-money"></i>
										<input type="text" class="input-large" name="paid" value="<?php echo @$row['Paid']; ?>"></span>
										</td>
									  </tr>		
                                      <tr>
										<td class="controls controls-row"> <label class="small-labels">Balance to Pay : </label>
                                        <span class="input-icon"> <i class="icon-money"></i>
										<input type="text" class="input-large" name="balance" value="<?php echo @$row['Balance']; ?>"></span>
										</td>
									  </tr>				
                                      </tbody>
                                      </table>
                                      ...
                                      <div class="span3">
											<table width="auto" border="0" cellpadding="3" cellspacing="0">
                                              ...
                                              <tr>
											      <td class="controls controls-row">
                                                    <h4 class=" blue">BANK INFO</h4>                                          
                                                  </td>
										        </tr>
                                                <tr>
											      <td class="controls controls-row">
                                                  <label class="small-labels">Bank Name : </label>
                                                  <span class="input-icon"><i class="icon-inbox"></i>
                                          <input type="text" class="input-large" name="bankname" value="<?php echo @$row['Bank Name']; ?>">
                                          </span><br>                                          
                                                  </td>
										        </tr>
											    <tr>
                                                  ...
                                                  <span class="input-icon"><i class="icon-inbox"></i>
                                          <input type="text" class="input-large" name="chequeno" value="<?php echo @$row['Cheque No']; ?>">
                                          </span><br>                                          
                                                  </td>
										        </tr>
											    <tr>
											   <td class="controls controls-row"> <label class="small-labels">Cheque Date</label>
                                               <span class="input-icon"> <i class="icon-calendar"></i>
											  <input type="text" id="inputField" class="input-large date-picker" name="chequedate" value="<?php if (@$row['Cheque Date']) { echo date('d-m-Y',strtotime(@$row['Cheque Date']));} ?>">
											        </span>
											       </td>
										        </tr>											    
											    <tr>
											      <td class="controls controls-row">
                                                  <label class="small-labels">Cheque Status</label>
                                                <select class="select"  name="chequestatus" width="31" value="<?php echo @$row['Cheque Status']; ?>">  
												  <?php  
                                                   echo '<option selected>' . @$row['Cheque Status'] . '</option>';
                                                   echo '<option>Not Cleared</option>';
