...
$query="SELECT `ID`,`Date`,Type,Bank,Amount,`Particulars`,`Cheque No` FROM cheque";
			...
			<div id="main-content" class="clearfix">
					...
					<div id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Cheque Register</li>
						</ul><!--.breadcrumb-->
					</div><!--#breadcrumbs-->
					...
					<div id="page-content" class="clearfix">
						...
						<div class="page-header position-relative">
							<h1>Cheque Register <small><i class="icon-double-angle-right"></i> List of Cheques</small></h1>
						</div><!--/page-header-->
...
<div class="row-fluid">
	<h3 class="header smaller lighter blue">Cheque Register </h3>
    <p>
    <a class="btn btn-small btn-success" href="chequedetail.php"><span>Add New</span></a>
    <a class="btn btn-small btn-yellow" href="exportcheque.php"><i class="icon-table"></i><span> Excel Report</span></a>
    <a class="btn btn-small btn-info" href="rptcheque.php"><i class="icon-print"></i><span> Print Report</span></a>
    </p>
	<div class="table-header">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
					<th class="hidden-480"><small>Cheque No</small></th>
					<th><small>Date</small></th>
					<th class="hidden-480"><small>Type</small></th>
					
					<th><small>Bank</small></th>
                     
                     <TH><small>Amount</small></TH>
                     
                     <TH><small>Particulars</small></TH>
			...
			<tbody>
    			...
    			{
				 $table="<TR>
				 <TD>$cheque</TD><TD>" . date('d-m-Y',strtotime($date)) . "</TD>
				 <TD>$type</TD><TD><small>$bank</small></TD><TD>$amount</TD>
				 <TD>$particulars</TD>
				 <td>
						<div class='hidden-phone visible-desktop btn-group'>
							<span class='btn btn-mini'><a href = 'chequedetail.php?ID=$id' class='white'><i class='icon-edit' data-rel='tooltip' title='Edit' data-placement='left'></i></a></span>
						...
						<div class='hidden-desktop visible-phone'>";
							$table.='<div class="inline position-relative">
								...
								<ul class="dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close">
									<li><a href="chequedetail.php?ID='.$id.'" class="tooltip-success" data-rel="tooltip" title="Edit" data-placement="left"><span class="green"><i class="icon-edit"></i></span></a></li>
