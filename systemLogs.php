...
//$query="SELECT `User Category`, `User Name` , `Date Logged On`, `Time Logged On`,`File Used`,`Details` From 
//		Monitor order by `Date Logged on` desc, `Time Logged On` desc";
...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>System Logs - POS Management System</title>
			...
			<div id="main-content" class="clearfix">
					...
					<div id="page-content" class="clearfix">
						...
						<div class="page-header position-relative">
							<h1>System Log <small><i class="icon-double-angle-right"></i> List of Auto-Log</small></h1>
				</div>
    <!--/page-header-->
...
<div class="row-fluid">
	<h3 class="header smaller lighter blue">Log List </h3>
</div>
<div class="row-fluid">    
    <form action="systemLogs.php" method="get" >
 ...
 <div class="row-fluid">    
	...
	<div class="table-header">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
					<th width="15%" class="hidden-480"><small>User Category</small></th>
					<th width="15%"><small>User Name</small></th>
					<th width="15%" class="hidden-480"><small>Date Logged</small></th>					
					<th width="15%"><small>Time Logged</small></th>                     
                    <TH width="10%"><small>File Used</small></TH>                     
                    <TH width="30%"><small>Details</small></TH>
				</tr>
			</thead>
...
echo "
       ...
       echo'  "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "server_processing5.php?dt='.$date.'"
    } );
	';
}else{
