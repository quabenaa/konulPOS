...
$query="SELECT login.user_id,login.username,login.access_lvl,cms_access_levels.access_name,login.email FROM login inner join cms_access_levels on login.access_lvl=cms_access_levels.access_lvl order by login.access_lvl desc";
			...
			<div id="main-content" class="clearfix">
					...
					<div id="page-content" class="clearfix">
						...
						<div class="page-header position-relative">
							<h1>Configuration <small><i class="icon-double-angle-right"></i> List of Users</small></h1>
				</div>
    <!--/page-header-->
...
<div class="row-fluid">
    ...
    <p>
    <a class='btn btn-small btn-success' href ='user.php'> New User </a>
	...
	<div class="table-header">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
                	<th>No.</th>
					<th class="hidden-480"><small>User ID</small></th>
					<th><small>User Name</small></th>
					<th class="hidden-480"><small>Access Level</small></th>
			...
			<tbody>
				...
				{$n++;
				 ...
				 <TD>$n</TD>
				 <TD>$user_id</TD>
				 <TD><a href ='user.php?UID=" . $user_id . "'> $username </a> </TD>
				 <TD>$access_lvl </TD>
      			<TD> $access_name</TD>
				<TD>$email</TD>
				<TD></TD>
