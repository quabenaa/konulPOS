...
$query="SELECT `ID`,`Stock Name`,`Stock Code`,`Stock Date`,`Qnty Given`,`Request By`,`Given By`,Destination 
			...
			<div id="main-content" class="clearfix">
					...
					<div id="page-content" class="clearfix">
						...
						<div class="page-header position-relative">
							<h1>Requisition <small><i class="icon-double-angle-right"></i> List for Products</small></h1>
						</div><!--/page-header-->
...
<div class="row-fluid">
	<h3 class="header smaller lighter blue">Requisition List </h3>
    <p>
    <a class="btn btn-small btn-success" href="requisitionupdate.php"><span>Add New</span></a>
    <a class="btn btn-small btn-yellow" href="exportrequisition.php"><span>Excel</span></a>
    <a class="btn btn-small btn-info" href="rptrequisition.php"><span>Print</span></a>
    </p>
	<div class="table-header">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
					<th>
                    <small>Requisition Date</small></th>
					<th>
                    <small>Stock Name</small>
                    </th>
					<th>
                    <small>Quantity Given</small>
                    </th>
					<th class='hidden-phone'><small>Requested By</small></th>
					<th class='hidden-phone'><small>Given By</small></th>
					<th class='hidden-phone'><small>Destination</small></th>
					<th></th>
				</tr>
			</thead>
			...
			<tbody>
				...
				while(list($id,$name,$code,$dates,$given,$reqby,$givenby,$loc)=mysql_fetch_row($result))
				{
				 ...
				 <TD>$dates</TD>
					...
					<td class='hidden-phone'>$reqby</td>
					<td class='hidden-phone'>$givenby</td>
