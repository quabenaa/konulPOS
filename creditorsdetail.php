...
$ID=$_REQUEST['ID'];
$sql="SELECT * FROM `creditor` WHERE `ID`='$ID' order by `Date` desc";
			...
			<div id="main-content" class="clearfix">
					...
					<div id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Creditors' Schedule</li>
						</ul><!--.breadcrumb-->
					</div><!--#breadcrumbs-->
					...
					<div id="page-content" class="clearfix">
						...
						<div class="page-header position-relative">
							<h1>Creditors' Schedule <small><i class="icon-double-angle-right"></i> Details</small></h1>
						</div><!--/page-header-->
						<form action="submitcreditor.php" method="post">
							<div class="row-fluid">
                                ...
                                <tbody>
								        <tr>
                                          ...
                                          <input class="input-large" type="text" name="company" value="<?php echo @$row['Company']; ?>">  </span>                                     
                                          </td>
						          </tr>
								        <tr>
								          <td class="controls controls-row">
									   ...
									   ?>
								        ...
								        <tr>
                                          ...
                                          <span class="input-icon"> <i class="icon-user"></i>
                                          <input class="input-large" type="text" name="contact" value="<?php echo @$row['Contact Person']; ?>">
                                          </span>                    
                                          <br>
                                          </td>
						          		</tr>
                                        <tr>
										<td class="controls controls-row"> <label class="small-labels">Credit Amount : </label>
