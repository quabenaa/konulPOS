...
<div class="row-fluid">
    ...
    <a class="btn btn-small btn-info" href="<?php echo $print ?>" target="_new"><span>Print</span></a>
    </p>
    <p class="pull-right">
    <a class="btn btn-small btn-danger" href="stocklist.php?exp=1"><span>View Expiring Items</span></a>
    <a class="btn btn-small btn-warning" href="stocklist.php?relvl=1" target="_new"><span>Re-Order Level Items</span></a>
    </p>
</div>
<div class="row-fluid">
...
if(isset($_REQUEST['exp'])){
	...
	echo "
       ...
       echo'  "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "server_processing1.php?exp=1"
    } );
	';
	...
	echo "
       ...
       echo'  "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "server_processing1.php?relvl=1"
