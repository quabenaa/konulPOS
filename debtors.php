...
$query="SELECT `ID`,`Date`,Company,`Contact Person`,Amount,`Balance` FROM debtor order by `Date` desc";
			...
			<div id="main-content" class="clearfix">
					...
					<div id="page-content" class="clearfix">
						...
						<div class="page-header position-relative">
							<h1>Debtors' Schedule <small><i class="icon-double-angle-right"></i> List of Debtors</small></h1>
						</div><!--/page-header-->
...
<div class="row-fluid">
	<h3 class="header smaller lighter blue">Debtors' List </h3>
    <p>
    <a class="btn btn-small btn-success" href="debtorsdetail.php"><span> Add New</span></a>
    <a class="btn btn-small btn-yellow" href="exportdebtors.php"><i class="icon-table"></i><span> Excel Report</span></a>
    <a class="btn btn-small btn-info" href="rptdebtors.php"><i class="icon-print"></i><span> Print Report</span></a>
    </p>
				...
				while(list($id,$date,$coy,$contact,$amount,$bal)=mysql_fetch_row($result))
				{
				 ...
				 <td>
						<div class='hidden-phone visible-desktop btn-group'>
							<span class='btn btn-mini'><a href = 'debtorsdetail.php?ID=$id' class='white'><i class='icon-edit' data-rel='tooltip' title='Edit' data-placement='left'></i></a></span>
						...
						<div class='hidden-desktop visible-phone'>";
							$table.='<div class="inline position-relative">
								...
								<ul class="dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close">
									<li><a href="debtorsdetail.php?ID='.$id.'" class="tooltip-success" data-rel="tooltip" title="Edit" data-placement="left"><span class="green"><i class="icon-edit"></i></span></a></li>
